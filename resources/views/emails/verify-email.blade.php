...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    <div style="width: 100%; background-color: #f1f1f1;display: flex;justify-content: center">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <h3><strong>Your Verification code is :</strong></h3>
                                        <h1><strong>
                                            {{--  @isset($verify_token)
                                                 {{ $verify_token->token }}
                                            @endisset  --}}

                                            {{--  {{ $user->verifyUser->pluck('token')->implode(', ') }}  --}}

                                            @if ($user->verifyUser->isNotEmpty())
                                                {{ $user->verifyUser->pluck('token')->implode(', ') }}
                                            @else
